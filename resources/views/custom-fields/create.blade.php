                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12" id="field-values-div" style="display: none;">
                                    ...
                                    <div class="form-group">
                                        <select id="values" name="values[]" data-tags="true" data-token-separators="[',']" data-placeholder="{{__("Select an option")}}" data-allow-clear="true" class="select2 w-100 full-width-select2" multiple="multiple" data-parsley-required="true"></select>

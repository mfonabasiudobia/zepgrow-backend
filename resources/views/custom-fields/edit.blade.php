                                ...
                                @if(in_array($custom_field->type,['radio','checkbox','dropdown']))
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <select id="values" name="values[]" data-tags="true" data-token-separators="[',']" data-placeholder="{{__("Select an option")}}" data-allow-clear="true" class="select2 col-12 w-100" multiple="multiple">

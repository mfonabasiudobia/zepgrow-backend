                    ...
                    <div class="col-12">
                        ...
                        <table class="table-borderless table-striped" aria-describedby="mydesc" id="table_list"
                            ...
                            <tr>
                                ...
                                <th scope="col" data-field="discounted_price" data-sortable="true">{{ __('Discounted Price') }}</th>
                                ...
                                @endcan
                                <th scope="col" data-field="rejected_reason" data-sortable="true" data-visible="true" data-formatter="rejectedReasonFormatter">{{ __('Rejected Reason') }}</th>
